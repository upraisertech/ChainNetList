      ...
      <div className="dark:text-[#B3B3B3] text-black dark:bg-[#0D0D0D] bg-white relative h-full">
        <div className="px-5 sticky top-0 bottom-0 m-auto flex flex-col items-center gap-8 justify-center h-[42em] md:h-screen max-w-[480px] mx-auto">
          ...
          <div className="flex flex-col gap-2 w-full">
            <a
              className="flex items-center justify-center mx-auto lg:ml-0 gap-2 rounded-[50px] font-medium py-3 px-6 shadow-lg w-full dark:bg-[#2F80ED] bg-[#2F80ED] dark:text-black text-white"
            ...
            <a
              className="flex items-center justify-center mx-auto lg:ml-0 gap-2 rounded-[50px] font-medium py-[12px] px-6 w-full dark:bg-[#0D0D0D] bg-white dark:text-[#2F80ED] text-[#2F80ED] border dark:border-[#171717] border-[#EAEAEA]"
